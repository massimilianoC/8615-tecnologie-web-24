<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    ...
    <?php if(isUserLoggedIn()) : ?>
      ...
      <i class="bi bi-bell-fill"></i><span class="position-absolute top-50 start-100 translate-middle badge rounded-pill bg-danger"><?php echo count($_SESSION['template']["notifications"]);?></span>
      </button>
    <?php endif; ?>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <?php if(isUserLoggedIn()) : ?>
        <li class="d-sm-none d-md-none d-lg-block"><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Notifiche <span class="badge rounded-pill text-bg-danger"><?php echo count($_SESSION['template']["notifications"]);?></span></button></li>
