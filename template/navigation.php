  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li><button type="button" class="btn btn-outline-light btn-sm" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Notifiche <span class="badge text-bg-secondary">4</span></button></li>
        ...
        <li class="nav-item"><a aria-current="page" class="nav-link <?php isActive("users") ?>" href="index.php?page=users"><i class="bi bi-people"></i> Utenit</a></li>
