        ...
        <?php foreach($_SESSION['template']["notifications"] as $notification) : ?>
          <ul class="list-group">
              <?php if($notification['fkFollow']!= NULL): ?>
                ...
                <?php if($notification['read'] > 0) echo ' read ' ; echo 'list-group-item-warning ' ?>"  role="alert">
              ...
              <?php elseif($notification['fkPost']!= NULL): ?>
                ...
                <li class="list-group-item alert alert-warning alert-dismissible fade show 
                <?php if($post['read'] > 0) echo ' read ' ; echo (($post['isComment']==0)? ' list-group-item-info ' : ' list-group-item-primary ') ?>"  role="alert">
