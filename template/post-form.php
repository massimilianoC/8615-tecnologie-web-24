...
<ul class="form post">
    <li class="post post-single-item">
        <ul class="collection posts detail">
            ...
            <li class="post-element input function buttons"><input class="btn btn-secondary upload post media button" type="file" id="mediaUpload" name="media" accept="image/png, image/jpeg, image/jpg, video/mp4" capture/></li>
